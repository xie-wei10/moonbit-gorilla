...
_M0DTPC15error5Error44localreview_2fgorilla_2eCodecError_2eInvalid.prototype.$tag = 1;
...
function _M0MP211localreview7gorilla6Reader3get(self, n) {
  ...
  while (true) {
    const _ = _tmp;
    if (_ < n) {
      const _tmp$2 = BigInt.asUintN(64, out.val << BigInt(1 & 63));
      const _tmp$3 = self.bytes;
      if (8 === 0) {
        $panic();
      }
      const _tmp$4 = self.pos / 8 | 0;
      const _tmp$5 = _M0MPC14byte4Byte10to__uint64(_tmp$4 >>> 0 < _tmp$3.length ? _tmp$3[_tmp$4] : $oob());
      if (8 === 0) {
        $panic();
      }
      out.val = BigInt.asUintN(64, _tmp$2 | BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, _tmp$5) >> BigInt((7 - (self.pos % 8 | 0) | 0) & 63)) & 1n));
...
function _M0FP411localreview7gorilla3cmd3web3run(input) {
  ...
  _L: {
    ...
    while (true) {
      ...
      const _bind$2 = " ";
      const p = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string10StringView5split(_tmp, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
      if (p.length !== 2) {
        return "ERROR: timestamp raw_uint64_bits";
      }
      const _bind$3 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 0));
      const _bind$4 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length), 0);
      let _tmp$2;
      if (_bind$4.$tag === 1) {
        const _ok = _bind$4;
        _tmp$2 = _ok._0;
      ...
      const _tmp$3 = _tmp$2;
      const _bind$5 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 1));
      const _bind$6 = _M0FPC28internal7strconv21parse__uint64_2einner(new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length), 0);
      let _tmp$4;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        _tmp$4 = _ok._0;
    ...
    const _bind$2 = _M0FP211localreview7gorilla6encode(samples);
    let data;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      data = _ok._0;
    ...
    const _bind$3 = _M0FP211localreview7gorilla6decode(data);
    let restored;
    if (_bind$3.$tag === 1) {
      const _ok = _bind$3;
      restored = _ok._0;
