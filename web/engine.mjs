...
function _M0MPC15array5Array5makeiGjE(length, f) {
  if (length <= 0) {
    return [];
  } else {
...
function _M0MPC16option6Option6unwrapGlE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPB3Map20add__entry__to__tailGsRPB4JsonE(self, idx, entry) {
  ...
  if (_bind$2 === -1) {
    ...
    _M0MPC16option6Option6unwrapGlE(_bind$2 >>> 0 < _tmp.length ? _tmp[_bind$2] : $oob()).next = entry;
  }
  self.tail = idx;
...
function _M0MPB3Map13remove__entryGiRP411xie_2dwei107gorilla3cmd3web14ArchiveSessionE(self, entry) {
  ...
  if (_bind$2 === -1) {
    ...
    const _tmp = self.entries;
    _M0MPC16option6Option6unwrapGlE(_bind$2 >>> 0 < _tmp.length ? _tmp[_bind$2] : $oob()).next = entry.next;
  }
...
function _M0IPC14uint4UIntPB6ToJson8to__json(self) {
  return _M0MPC14json4Json6number($f64_convert_i64_u(BigInt.asUintN(64, _M0MPC14uint4UInt10to__uint64(self))), undefined);
}
...
function _M0MPC15array5Array12view_2einnerGyE(self, start, end) {
  ...
  if (start >= 0 && (start <= end$2 && end$2 <= len)) {
    ...
    return new _M0TPB9ArrayViewGyE(_bind$2, start, start + _bind$3 | 0);
  } else {
...
function _M0IP211xie_2dwei107gorilla10CodecErrorPC15debug5Debug8to__reprGRP211xie_2dwei107gorilla10CodecErrorE(_x_223) {
  ...
  _L: {
    ...
    const _$42$arg_224 = _Invalid._0;
...
function _M0MP211xie_2dwei107gorilla6Reader3get(self, n) {
  ...
  while (true) {
    if (remaining.val > 0) {
      ...
      const available = 8 - (self.pos % 8 | 0) | 0;
      const take = _M0MPC13int3Int3min(remaining.val, available);
      const _tmp = self.bytes;
      if (8 === 0) {
        $panic();
      }
      const _tmp$2 = self.pos / 8 | 0;
      const bits = (_tmp$2 >>> 0 < _tmp.length ? _tmp[_tmp$2] : $oob()) >> (available - take | 0) & ((1 << take) - 1 | 0);
      out.val = BigInt.asUintN(64, BigInt.asUintN(64, out.val << BigInt(take & 63)) | _M0MPC13int3Int10to__uint64(bits));
      self.pos = self.pos + take | 0;
      remaining.val = remaining.val - take | 0;
      continue;
    } else {
      break;
    }
...
function _M0MP211xie_2dwei107gorilla6Writer3put(self, n, width) {
  ...
  while (true) {
    if (remaining.val > 0) {
      const take = _M0MPC13int3Int3min(remaining.val, 8 - self.used | 0);
      const bits = Number(BigInt.asIntN(32, BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, n) >> BigInt((remaining.val - take | 0) & 63)) & BigInt.asUintN(64, BigInt.asUintN(64, 1n << BigInt(take & 63)) - 1n)))) | 0;
      self.partial = self.partial << take | bits;
      self.used = self.used + take | 0;
      remaining.val = remaining.val - take | 0;
      if (self.used === 8) {
...
function _M0MP211xie_2dwei107gorilla10XorEncoder8snapshot(self) {
  ...
  _M0MPC15array5Array3setGyE(bytes, 0, self.count >> 8 & 255);
  ...
  _L: {
    ...
    if (self.index === 0) {
      ...
      if (self.index === 1) {
        ...
        while (true) {
          if (ones.val < 4) {
            ...
            ones.val = ones.val + 1 | 0;
            continue;
          } else {
            break;
          }
        }
        const _bind$2 = ones.val;
        let width;
        switch (_bind$2) {
          case 0: {
            width = 0;
        ...
        if (width > 0) {
          ...
          const difference = width < 64 && BigInt.asUintN(64, n) > BigInt.asUintN(64, BigInt.asUintN(64, 1n << BigInt((width - 1 | 0) & 63))) ? BigInt.asUintN(64, n - BigInt.asUintN(64, 1n << BigInt(width & 63))) : n;
          self.delta = BigInt.asUintN(64, self.delta + difference);
        }
      }
      self.time = BigInt.asUintN(64, self.time + self.delta);
      const _bind$2 = _M0MP211xie_2dwei107gorilla6Reader3get(reader, 1);
      ...
      if (BigInt.asUintN(64, _tmp) === BigInt.asUintN(64, 1n)) {
        ...
        self.bits = BigInt.asUintN(64, _tmp$3 ^ BigInt.asUintN(64, _tmp$4 << BigInt(self.trailing & 63)));
      }
    }
    self.index = self.index + 1 | 0;
    if (self.index === self.count) {
...
function _M0FP211xie_2dwei107gorilla12archive__put(out, value, width) {
  ...
  while (true) {
    const i = _tmp;
    if (i >= 0) {
      _M0MPC15array5Array4pushGyE(out, _M0MPC16uint646UInt648to__byte(BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, value) >> BigInt((Math.imul(8, i) | 0) & 63)) & 255n)));
      _tmp = i - 1 | 0;
      continue;
    } else {
      return;
...
function _M0FP211xie_2dwei107gorilla12archive__get(bytes, offset, width) {
  ...
  while (true) {
    ...
    if (i < width) {
      ...
      value.val = BigInt.asUintN(64, _tmp$2 | _M0MPC14byte4Byte10to__uint64(_tmp$3 >>> 0 < bytes.length ? bytes[_tmp$3] : $oob()));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP211xie_2dwei107gorilla22archive__index__length(trailer) {
  ...
  let _tmp$2;
  if (BigInt.asUintN(64, length) < BigInt.asUintN(64, 12n)) {
    _tmp$2 = true;
  } else {
    let _tmp$3;
    if (BigInt.asUintN(64, length) > BigInt.asUintN(64, 2359308n)) {
      _tmp$3 = true;
    } else {
      if (36n === 0n) {
        $panic();
      }
      _tmp$3 = BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, length - 12n)) % BigInt.asUintN(64, 36n))) !== BigInt.asUintN(64, 0n);
    }
    _tmp$2 = _tmp$3;
  }
  if (_tmp$2) {
...
function _M0MP211xie_2dwei107gorilla12ArchiveIndex3new(index, file_size) {
  ...
  if (index.length < 12) {
    ...
    if (index.length > 2359308) {
      ...
      _tmp$2 = BigInt.asUintN(64, _tmp$3) !== BigInt.asUintN(64, 1229215794n);
    }
    _tmp = _tmp$2;
  }
  if (_tmp) {
  ...
  const previous = new _M0TPB8MutLocalGOlE(undefined);
  const _bind$4 = 0;
  const _bind$5 = Number(BigInt.asIntN(32, count)) | 0;
  let _tmp$4 = _bind$4;
  while (true) {
    const i = _tmp$4;
    if (i < _bind$5) {
...
function _M0MP211xie_2dwei107gorilla12ArchiveIndex6select(self, start, end) {
  ...
  while (true) {
    if (lo.val < hi.val) {
      ...
      const mid = _tmp + ((hi.val - lo.val | 0) / 2 | 0) | 0;
      if (BigInt.asIntN(64, _M0MPC15array5Array2atGRPC16string10StringViewE(self.blocks, mid).last) < BigInt.asIntN(64, start)) {
        lo.val = mid + 1 | 0;
      } else {
        hi.val = mid;
      }
  ...
  const result = [];
  while (true) {
    if (lo.val < self.blocks.length && BigInt.asIntN(64, _M0MPC15array5Array2atGRPC16string10StringViewE(self.blocks, lo.val).first) <= BigInt.asIntN(64, end)) {
      _M0MPC15array5Array4pushGiE(result, lo.val);
      lo.val = lo.val + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP211xie_2dwei107gorilla14ArchiveDecoder4feed(self, data) {
  ...
  _L: {
    ...
    const samples = [];
    while (true) {
      const available = self.buffer.length - self.cursor | 0;
      if (!self.header) {
        if (available < 8) {
          break;
        }
      ...
      if (BigInt.asUintN(64, marker) === BigInt.asUintN(64, 1112296242n)) {
        if (available < 28) {
          break;
        }
        if (self.entries.length >= 65536) {
    ...
    if (self.cursor > 0) {
      const remaining = _M0MPC15array9ArrayView9to__ownedGyE(_M0MPC15array5Array12view_2einnerGyE(self.buffer, self.cursor, undefined));
      _M0MPC15array5Array5clearGyE(self.buffer);
      const _bind$3 = remaining.length;
      let _tmp$2 = 0;
      while (true) {
        const _ = _tmp$2;
        if (_ < _bind$3) {
...
function _M0FP411xie_2dwei107gorilla3cmd3web3run(input) {
  ...
  _L: {
    ...
    while (true) {
      ...
      const _tmp = _M0MPC16string10StringView4trim(line, undefined);
      const _bind$3 = " ";
      const p = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string10StringView5split(_tmp, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
      if (p.length !== 2) {
        return "ERROR: timestamp raw_uint64_bits";
      }
      const _bind$4 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 0));
      const _bind$5 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length), 0);
      let _tmp$2;
      if (_bind$5.$tag === 1) {
        const _ok = _bind$5;
        _tmp$2 = _ok._0;
      ...
      const _tmp$3 = _tmp$2;
      const _bind$6 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(p, 1));
      const _bind$7 = _M0FPC28internal7strconv21parse__uint64_2einner(new _M0TPC16string10StringView(_bind$6, 0, _bind$6.length), 0);
      let _tmp$4;
      if (_bind$7.$tag === 1) {
        const _ok = _bind$7;
        _tmp$4 = _ok._0;
...
function _M0FP411xie_2dwei107gorilla3cmd3web13read__samples(value) {
  ...
  return _M0MPC15array5Array3mapGRPB4JsonRP211xie_2dwei107gorilla6SampleEHRPC15error5Error(items, (item) => {
    _L$2: {
      ...
      const _bind$2 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(time, 0, time.length), 0);
      let _tmp;
      if (_bind$2.$tag === 1) {
        const _ok = _bind$2;
        _tmp = _ok._0;
      ...
      const _tmp$2 = _tmp;
      const _bind$3 = _M0FPC28internal7strconv21parse__uint64_2einner(new _M0TPC16string10StringView(bits, 0, bits.length), 0);
      let _tmp$3;
      if (_bind$3.$tag === 1) {
        const _ok = _bind$3;
        _tmp$3 = _ok._0;
...
function _M0FP411xie_2dwei107gorilla3cmd3web24archive__integer_2einner(request, key, default_) {
  ...
  _L: {
    if (request.$tag === 6) {
      ...
      return new _M0DTPC16result6ResultGiRPB7FailureE3Err(new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("expected object"));
    }
  }
  let n;
  _L$2: {
    ...
    if (_bind$2 === undefined) {
      return new _M0DTPC16result6ResultGiRPB7FailureE2Ok(default_);
    } else {
      const _Some = _bind$2;
      const _x = _Some;
      if (_x.$tag === 3) {
        ...
        return new _M0DTPC16result6ResultGiRPB7FailureE3Err(new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("expected integer"));
      }
    }
  }
  if (n === _M0MPC16double6Double5trunc(n) && (n >= 0 && n <= 2147483647)) {
    return new _M0DTPC16result6ResultGiRPB7FailureE2Ok(_M0MPC16double6Double7to__int(n));
  } else {
...
function _M0FP411xie_2dwei107gorilla3cmd3web9from__hex(hex) {
  ...
  const _bind$2 = _M0MPC16string6String9to__array(hex);
  const _bind$3 = _bind$2.length;
  let _tmp$2 = 0;
  while (true) {
    const i = _tmp$2;
...
function _M0FP411xie_2dwei107gorilla3cmd3web11codec__json(input) {
  ...
  _L: {
    ...
    _L$2: {
      _L$3: {
        ...
        _L$4: {
          _L$5: {
            ...
            _L$6: {
              _L$7: {
                ...
                _L$8: {
                  if (request.$tag === 6) {
                    const _Object = request;
                    const _x = _Object._0;
                    const _x$2 = _M0MPB3Map3getGsRPB4JsonE(_x, "operation");
                    if (_x$2 === undefined) {
                      break _L$3;
                    } else {
                      const _Some = _x$2;
                      ...
                      if (_x$3.$tag === 4) {
                        ...
                        switch (_x$4) {
                          case "benchmark": {
                            const _x$5 = _M0MPB3Map3getGsRPB4JsonE(_x, "samples");
                            if (_x$5 === undefined) {
                              break _L$3;
                            } else {
                              const _Some$2 = _x$5;
                              const _samples = _Some$2;
                              samples$2 = _samples;
                              break _L$8;
                            }
                          }
                          case "encode": {
                            ...
                            if (_x$6 === undefined) {
                              ...
                              if (_x$7.$tag === 4) {
                                ...
                                const _format = _String$2._0;
                                const _x$8 = _M0MPB3Map3getGsRPB4JsonE(_x, "samples");
                                if (_x$8 === undefined) {
                                  break _L$3;
                                } else {
                                  const _Some$3 = _x$8;
                                  const _samples = _Some$3;
                                  format$2 = _format;
                                  samples = _samples;
                                  break _L$7;
                                }
                          ...
                          case "decode": {
                            const _x$7 = _M0MPB3Map3getGsRPB4JsonE(_x, "format");
                            if (_x$7 === undefined) {
                              break _L$3;
                            } else {
                              const _Some$2 = _x$7;
                              ...
                              if (_x$8.$tag === 4) {
                                ...
                                const _format = _String$2._0;
                                const _x$9 = _M0MPB3Map3getGsRPB4JsonE(_x, "hex");
                                if (_x$9 === undefined) {
                                  break _L$3;
                                } else {
                                  const _Some$3 = _x$9;
                ...
                if (repeats < 1 || repeats > 100) {
                  _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("repeat limit");
                  break _L;
                }
              ...
              switch (format$2) {
                ...
                default: {
                  _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("unknown format");
                  break _L;
                }
              }
          ...
          if (request.$tag === 6) {
            const _Object = request;
            const _x = _Object._0;
            const _x$2 = _M0MPB3Map3getGsRPB4JsonE(_x, "strict");
            if (_x$2 === undefined) {
              strict = true;
            } else {
              const _Some = _x$2;
      ...
      _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("unknown codec request");
      break _L;
    }
...
function _M0FP411xie_2dwei107gorilla3cmd3web14compress__text(source) {
  ...
  _L: {
    ...
    while (true) {
      ...
      const _bind$4 = " ";
      const _tmp$3 = _M0MPC16string6String12replace__all(_tmp, _tmp$2, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length));
      const _bind$5 = " ";
      const parts = _M0MPB4Iter9to__arrayGRPC16string10StringViewE(_M0MPB4Iter6filterGRPC16string10StringViewE(_M0MPC16string6String5split(_tmp$3, new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length)), (s) => !_M0MPC16string10StringView9is__empty(s)));
      if (parts.length !== 2) {
        _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("expected timestamp raw_uint64_bits");
        break _L;
      }
      const _bind$6 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(parts, 0));
      const _bind$7 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(_bind$6, 0, _bind$6.length), 0);
      let _tmp$4;
      if (_bind$7.$tag === 1) {
        const _ok = _bind$7;
        _tmp$4 = _ok._0;
      ...
      const _tmp$5 = _tmp$4;
      const _bind$8 = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPC16string10StringViewE(parts, 1));
      const _bind$9 = _M0FPC28internal7strconv21parse__uint64_2einner(new _M0TPC16string10StringView(_bind$8, 0, _bind$8.length), 0);
      let _tmp$6;
      if (_bind$9.$tag === 1) {
        const _ok = _bind$9;
        _tmp$6 = _ok._0;
...
function _M0FP411xie_2dwei107gorilla3cmd3web16decompress__text(hex, start, end) {
  ...
  _L: {
    ...
    const _bind$3 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(end, 0, end.length), 0);
    let high;
    if (_bind$3.$tag === 1) {
      const _ok = _bind$3;
      high = _ok._0;
      ...
      _L$3: {
        ...
        _L$4: {
            ...
            _L$6: {
              _L$7: {
                ...
                _L$8: {
                        ...
                        if (_x$3.$tag === 4) {
                          ...
                          switch (_x$4) {
                            ...
                            case "decoder": {
                              ...
                              const _bind$8 = [{ _0: "session", _1: _M0IPC13int3IntPB6ToJson8to__json(_tmp$3) }];
                              result = _M0MPC14json4Json6object(_M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$8, 0, 1), undefined));
                              break;
                            }
                            case "indexLength": {
                              const _x$5 = _M0MPB3Map3getGsRPB4JsonE(_x, "hex");
                              if (_x$5 === undefined) {
                                operation = _x$4;
                                break _L$5;
                              } else {
                            ...
                            case "index": {
                              const _x$6 = _M0MPB3Map3getGsRPB4JsonE(_x, "hex");
                              if (_x$6 === undefined) {
                                operation = _x$4;
                                break _L$5;
                              } else {
                                ...
                                if (_x$7.$tag === 4) {
                                  const _String$2 = _x$7;
                                  const _hex = _String$2._0;
                                  const _x$8 = _M0MPB3Map3getGsRPB4JsonE(_x, "fileSize");
                                  if (_x$8 === undefined) {
                                    operation = _x$4;
                                    break _L$5;
                                  } else {
                  ...
                  result = _M0IPC13int3IntPB6ToJson8to__json(_tmp$2);
                }
                break _L$6;
              }
              const _bind$3 = _M0FP411xie_2dwei107gorilla3cmd3web9from__hex(hex);
              ...
              const _tmp$2 = _tmp;
              const _bind$4 = _M0FPC28internal7strconv21parse__uint64_2einner(new _M0TPC16string10StringView(size, 0, size.length), 0);
              let _tmp$3;
              if (_bind$4.$tag === 1) {
                const _ok = _bind$4;
                _tmp$3 = _ok._0;
          ...
          _L$6: {
              ...
              _L$8: {
                _L$9: {
                  ...
                  _L$10: {
                              ...
                              _L$16: {
                                _L$17: {
                                  ...
                                  _L$18: {
                                    switch (session.$tag) {
                                      case 0: {
                                        const _Encoding = session;
                                        const _encoder = _Encoding._0;
                                        switch (operation) {
                                          case "append": {
                                            if (request.$tag === 6) {
                                              const _Object = request;
                                              const _x = _Object._0;
                                              const _x$2 = _M0MPB3Map3getGsRPB4JsonE(_x, "samples");
                                              if (_x$2 === undefined) {
                                                break _L$7;
                                              } else {
                                                const _Some = _x$2;
                                                const _samples = _Some;
                                                encoder$2 = _encoder;
                                                samples = _samples;
                                                break _L$18;
                                              }
                                      ...
                                      case 1: {
                                        const _Decoding = session;
                                        const _decoder = _Decoding._0;
                                        switch (operation) {
                                          case "feed": {
                                            if (request.$tag === 6) {
                                              const _Object = request;
                                              const _x = _Object._0;
                                              const _x$2 = _M0MPB3Map3getGsRPB4JsonE(_x, "hex");
                                              if (_x$2 === undefined) {
                                                break _L$7;
                                              } else {
                                                const _Some = _x$2;
                                      ...
                                      default: {
                                        const _Indexed = session;
                                        const _index = _Indexed._0;
                                        switch (operation) {
                                          case "select": {
                                            if (request.$tag === 6) {
                                              const _Object = request;
                                              const _x = _Object._0;
                                              const _x$2 = _M0MPB3Map3getGsRPB4JsonE(_x, "start");
                                              if (_x$2 === undefined) {
                                                break _L$7;
                                              } else {
                                                const _Some = _x$2;
                                                ...
                                                if (_x$3.$tag === 4) {
                                                  const _String = _x$3;
                                                  const _start = _String._0;
                                                  const _x$4 = _M0MPB3Map3getGsRPB4JsonE(_x, "end");
                                                  if (_x$4 === undefined) {
                                                    break _L$7;
                                                  } else {
                                                    const _Some$2 = _x$4;
                    ...
                    const _bind$5 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(start, 0, start.length), 0);
                    let _tmp;
                    if (_bind$5.$tag === 1) {
                      const _ok = _bind$5;
                      _tmp = _ok._0;
                    ...
                    const _tmp$2 = _tmp;
                    const _bind$6 = _M0FPC28internal7strconv20parse__int64_2einner(new _M0TPC16string10StringView(end, 0, end.length), 0);
                    let _tmp$3;
                    if (_bind$6.$tag === 1) {
                      const _ok = _bind$6;
                      _tmp$3 = _ok._0;
                    ...
                    result = _M0IPC15array5ArrayPB6ToJson8to__jsonGiE(_tmp$4);
                  }
                  break _L$8;
                }
            ...
            _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("invalid archive operation");
            break _L;
          }
        }
        break _L$2;
      }
      _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("invalid archive request");
      break _L;
    }
    const _bind$3 = [{ _0: "ok", _1: _M0MPC14json4Json7boolean(true) }, { _0: "result", _1: result }];
    return _M0MPC14json4Json17stringify_2einner(_M0MPC14json4Json6object(_M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$3, 0, 2), undefined)), false, 0, undefined);
